...
describe('Expenses routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IExpenses returned by find', () => {
      // GIVEN
      service.find = jest.fn(expenseId => of(new HttpResponse({ body: { expenseId } })));
      mockActivatedRouteSnapshot.params = { expenseId: 123 };
      ...
      expect(resultExpenses).toEqual({ expenseId: 123 });
    });
