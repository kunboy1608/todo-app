...
import { EntityArrayResponseType, NotesService } from '../service/notes.service';
...
export class NotesComponent implements OnInit {
  ...
  trackNoteId = (_index: number, item: INotes): number => this.notesService.getNotesIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: INotes[] | null): INotes[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.notesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
