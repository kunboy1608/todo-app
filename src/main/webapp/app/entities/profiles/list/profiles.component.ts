...
import { EntityArrayResponseType, ProfilesService } from '../service/profiles.service';
...
export class ProfilesComponent implements OnInit {
  ...
  trackProfileId = (_index: number, item: IProfiles): number => this.profilesService.getProfilesIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IProfiles[] | null): IProfiles[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.profilesService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
